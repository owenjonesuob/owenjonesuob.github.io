...
image: netdiag1jpg.jpg
categories:
- backpropagation
- machine learning
- Maths
- neural network
description: Deriving the backpropagation formulae, and a network diagram for one of my
  previous projects
---
<p>By creating a <a href="../2016-09-30-digit-recognition-building-a-neural-network-from-scratch-in-r/index.qmd">digit-recognizing neural network</a> - and then writing up the process I followed in order to do so - I was aiming not just to create a working net, but to solidify my understanding of the concepts and calculations involved. Generally speaking, I would say I achieved this.</p>
