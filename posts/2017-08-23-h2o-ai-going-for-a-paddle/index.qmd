...
- package
- R
description: A brief dive into the H2O machine learning framework
---
...
```rh2o_results <- do_h2o(ntrees = 10, nfolds = 2)
print(h2o_results)```
